...
const setVector3 = (x,y,z) => {
	if (!sharedVector3) {
		// defensive: sharedVector3 should be initialized in init(), but guard against early calls
		console.warn('setVector3 called before Ammo vector initialized — returning a noop vector')
		return { setValue: () => {}, x: 0, y: 0, z: 0 }
	}
